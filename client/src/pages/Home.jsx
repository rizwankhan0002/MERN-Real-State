  ...
  return (
    <div>
      ...
      <div className='flex flex-col gap-6 py-28 px-3 max-w-6xl mx-auto'>
        <h1 className='text-slate-700 font-bold text-3xl lg:text-3xl'>Find your next <span className='text-slate-500'>perfect</span>
        <br />
        place with ease</h1>
      ...
      <div className='max-w-6xl mx-auto my-10 gap-8 p-3 flex flex-col'>
        {
          offerListings && offerListings.length > 0 && (
            <div>
              <div className='my-3'>
